...
import { compressHeroImage, validateImageFile } from "@/lib/image-compression";
...
export default function AdminSettingsPage() {
  ...
  async function uploadHeroImage() {
    ...
    const compressedFile = await compressHeroImage(selectedFile);
    const safeFileName = `hero-${Date.now()}-${Math.random()
      .toString(36)
      .slice(2, 8)}.webp`;
  ...
  function handleHeroFileSelect(file: File | null) {
    if (!file) {
      return;
    }
  ...
  function handleHeroCropComplete(file: File) {
