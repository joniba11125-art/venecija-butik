  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter((product) => {
      ...
      const matchesCategory =
        selectedCategory === "all" || ((product.categories ?? [product.category]).includes(selectedCategory));
          ...
          <div className="mb-8 rounded-[2rem] border bg-white/95 p-4 shadow-sm backdrop-blur">
            <div className="grid gap-3 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1fr_auto]">
              ...
              <button
                ...
                className="inline-flex h-11 min-w-[104px] items-center justify-center gap-2 rounded-full border border-[#7a1020]/20 !bg-white px-5 text-sm font-semibold !text-[#7a1020] shadow-sm transition hover:!bg-[#fff0ee] hover:!text-[#4b0711]"
              >
